...
/**
 * gst_mpegts_section_new_pat:
 *
 * Allocates a new #GPtrArray for #GstMpegTsPatProgram
 *
 * Returns: (transfer full) A newly allocated #GPtrArray
 */
GPtrArray *
gst_mpegts_section_new_pat (void)
{
  GPtrArray *pat;
...
/**
 * gst_mpegts_section_new_pat_program:
 *
 ...
 */
GstMpegTsPatProgram *
gst_mpegts_section_new_pat_program (void)
{
  GstMpegTsPatProgram *program;
 ...
 * @pat: (transfer full) a #GPtrArray with #GstMpegTsPatPrograms
 * @ts_id: Transport stream ID of the PAT
 *
 * Creates a PAT #GstMpegTsSection from the @pat array of #GstMpegTsPatPrograms
 *
 * Returns: (tranfer full) a #GstMpegTsSection
 */
GstMpegTsSection *
 ...
 */
GstMpegTsPMT *
gst_mpegts_section_new_pmt (void)
{
  GstMpegTsPMT *pmt;
...
/**
 * gst_mpegts_section_new_pmt_stream:
 *
 ...
 */
GstMpegTsPMTStream *
gst_mpegts_section_new_pmt_stream (void)
{
