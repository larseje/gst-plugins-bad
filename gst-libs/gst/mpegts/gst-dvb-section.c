 ...
 */
GstMpegTsNIT *
gst_mpegts_section_new_nit (void)
{
  GstMpegTsNIT *nit;
...
/**
 * gst_mpegts_section_new_nit_stream:
 *
 ...
 */
GstMpegTsNITStream *
gst_mpegts_section_new_nit_stream (void)
{
